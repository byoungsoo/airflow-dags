...
args = {
    "project_id": "mlops-0710015729",
}

dag = DAG(
    dag_id="mlops-0710015729",
    default_args=args,
    schedule="@once",
...
op_34a75240_0f24_401e_b59c_ce3ede0120b8 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'mlops' --cos-endpoint http://minio.minio --cos-bucket airflow-dags --cos-directory 'mlops-0710015729' --cos-dependencies-archive '03_learn_model-34a75240-0f24-401e-b59c-ce3ede0120b8.tar.gz' --file 'lab-env/pipeline/03_learn_model.py' "
    ],
...
op_90f52c9d_eb61_4ce4_ba9c_e247290a10b9 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'mlops' --cos-endpoint http://minio.minio --cos-bucket airflow-dags --cos-directory 'mlops-0710015729' --cos-dependencies-archive '05_deploy-90f52c9d-eb61-4ce4-ba9c-e247290a10b9.tar.gz' --file 'lab-env/pipeline/05_deploy.py' "
    ],
    task_id="05_deploy",
    env_vars={

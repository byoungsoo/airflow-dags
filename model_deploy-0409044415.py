...
args = {
    "project_id": "model_deploy-0409044415",
}

dag = DAG(
    dag_id="model_deploy-0409044415",
    default_args=args,
    schedule="@once",

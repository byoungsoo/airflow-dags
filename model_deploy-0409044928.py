...
args = {
    "project_id": "model_deploy-0409044928",
}

dag = DAG(
    dag_id="model_deploy-0409044928",
    default_args=args,
    schedule="@once",

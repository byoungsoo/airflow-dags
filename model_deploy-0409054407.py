...
args = {
    "project_id": "model_deploy-0409054407",
}

dag = DAG(
    dag_id="model_deploy-0409054407",
    default_args=args,
    schedule="@once",

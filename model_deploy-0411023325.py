...
args = {
    "project_id": "model_deploy-0411023325",
}

dag = DAG(
    dag_id="model_deploy-0411023325",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0411054333",
}

dag = DAG(
    dag_id="model_deploy-0411054333",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0411055532",
}

dag = DAG(
    dag_id="model_deploy-0411055532",
    default_args=args,
    schedule="@once",
...
# Operator source: Machine-Learning-on-Kubernetes/Chapter07/model_deploy_pipeline/model_deploy/deploy_model.py

op_8409db05_bd89_4df0_abcb_705d7e214aed = KubernetesPodOperator(
    name="deploy_model",
    namespace="airflow",
    image="202949997891.dkr.ecr.ap-northeast-2.amazonaws.com/common/build:kaniko",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'model_deploy' --cos-endpoint http://minio.minio.svc.cluster.local:9000 --cos-bucket minio-airflow --cos-directory 'model_deploy-0411055532' --cos-dependencies-archive 'deploy_model-8409db05-bd89-4df0-abcb-705d7e214aed.tar.gz' --file 'Machine-Learning-on-Kubernetes/Chapter07/model_deploy_pipeline/model_deploy/deploy_model.py' "
    ],
...
op_8409db05_bd89_4df0_abcb_705d7e214aed.image_pull_policy = "Always"

op_8409db05_bd89_4df0_abcb_705d7e214aed << op_05b70e06_79ee_4046_8e38_d81304c8c267

...
args = {
    "project_id": "model_deploy-0411060146",
}

dag = DAG(
    dag_id="model_deploy-0411060146",
    default_args=args,
    schedule="@once",

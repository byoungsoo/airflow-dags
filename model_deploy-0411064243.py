...
args = {
    "project_id": "model_deploy-0411064243",
}

dag = DAG(
    dag_id="model_deploy-0411064243",
    default_args=args,
    schedule="@once",

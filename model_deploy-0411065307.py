...
args = {
    "project_id": "model_deploy-0411065307",
}

dag = DAG(
    dag_id="model_deploy-0411065307",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0411070036",
}

dag = DAG(
    dag_id="model_deploy-0411070036",
    default_args=args,
    schedule="@once",

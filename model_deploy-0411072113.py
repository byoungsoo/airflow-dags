...
args = {
    "project_id": "model_deploy-0411072113",
}

dag = DAG(
    dag_id="model_deploy-0411072113",
    default_args=args,
    schedule="@once",

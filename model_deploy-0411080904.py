...
args = {
    "project_id": "model_deploy-0411080904",
}

dag = DAG(
    dag_id="model_deploy-0411080904",
    default_args=args,
    schedule="@once",

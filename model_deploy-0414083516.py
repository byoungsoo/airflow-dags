...
args = {
    "project_id": "model_deploy-0414083516",
}

dag = DAG(
    dag_id="model_deploy-0414083516",
    default_args=args,
    schedule="@once",

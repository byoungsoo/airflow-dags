...
args = {
    "project_id": "model_deploy-0414084403",
}

dag = DAG(
    dag_id="model_deploy-0414084403",
    default_args=args,
    schedule="@once",

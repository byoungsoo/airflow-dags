...
args = {
    "project_id": "model_deploy-0415005322",
}

dag = DAG(
    dag_id="model_deploy-0415005322",
    default_args=args,
    schedule="@once",

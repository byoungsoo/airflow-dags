...
args = {
    "project_id": "model_deploy-0415011527",
}

dag = DAG(
    dag_id="model_deploy-0415011527",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0415042933",
}

dag = DAG(
    dag_id="model_deploy-0415042933",
    default_args=args,
    schedule="@once",

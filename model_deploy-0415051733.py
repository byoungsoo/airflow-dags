...
args = {
    "project_id": "model_deploy-0415051733",
}

dag = DAG(
    dag_id="model_deploy-0415051733",
    default_args=args,
    schedule="@once",

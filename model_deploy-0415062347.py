...
args = {
    "project_id": "model_deploy-0415062347",
}

dag = DAG(
    dag_id="model_deploy-0415062347",
    default_args=args,
    schedule="@once",

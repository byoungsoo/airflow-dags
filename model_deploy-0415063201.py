...
args = {
    "project_id": "model_deploy-0415063201",
}

dag = DAG(
    dag_id="model_deploy-0415063201",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0416052631",
}

dag = DAG(
    dag_id="model_deploy-0416052631",
    default_args=args,
    schedule="@once",

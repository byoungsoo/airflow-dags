...
args = {
    "project_id": "model_deploy-0416073953",
}

dag = DAG(
    dag_id="model_deploy-0416073953",
    default_args=args,
    schedule="@once",

...
args = {
    "project_id": "model_deploy-0416074648",
}

dag = DAG(
    dag_id="model_deploy-0416074648",
    default_args=args,
    schedule="@once",

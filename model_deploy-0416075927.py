...
args = {
    "project_id": "model_deploy-0416075927",
}

dag = DAG(
    dag_id="model_deploy-0416075927",
    default_args=args,
    schedule="@once",

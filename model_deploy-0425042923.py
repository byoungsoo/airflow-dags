...
args = {
    "project_id": "model_deploy-0425042923",
}

dag = DAG(
    dag_id="model_deploy-0425042923",
    default_args=args,
    schedule="@once",

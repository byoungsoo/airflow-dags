...
args = {
    "project_id": "model_deploy-0428010009",
}

dag = DAG(
    dag_id="model_deploy-0428010009",
    default_args=args,
    schedule="@once",

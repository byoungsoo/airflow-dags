...
args = {
    "project_id": "model_deploy-0428014905",
}

dag = DAG(
    dag_id="model_deploy-0428014905",
    default_args=args,
    schedule="@once",

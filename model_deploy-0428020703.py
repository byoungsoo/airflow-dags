...
args = {
    "project_id": "model_deploy-0428020703",
}

dag = DAG(
    dag_id="model_deploy-0428020703",
    default_args=args,
    schedule="@once",

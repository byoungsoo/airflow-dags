...
args = {
    "project_id": "model_deploy-0428054045",
}

dag = DAG(
    dag_id="model_deploy-0428054045",
    default_args=args,
    schedule="@once",
...
# Operator source: Machine-Learning-on-Kubernetes/Chapter07/model_deploy_pipeline/model_deploy/deploy_model_bys.py

op_64cea8a9_2c46_43ff_9b26_57896583fd00 = KubernetesPodOperator(
    name="deploy_model_bys",
    namespace="airflow",
    image="202949997891.dkr.ecr.ap-northeast-2.amazonaws.com/common/build:kaniko",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'model_deploy' --cos-endpoint http://minio.minio.svc.cluster.local:9000 --cos-bucket minio-airflow --cos-directory 'model_deploy-0428054045' --cos-dependencies-archive 'deploy_model_bys-64cea8a9-2c46-43ff-9b26-57896583fd00.tar.gz' --file 'Machine-Learning-on-Kubernetes/Chapter07/model_deploy_pipeline/model_deploy/deploy_model_bys.py' "
    ],
    task_id="deploy_model_bys",
    env_vars={
        "AWS_REGION": "us-east-1",
        "EKS_CLUSTER_NAME": "bys-dev-ue1-eks-mlops",
        "ELYRA_RUNTIME_ENV": "airflow",
        "AWS_ACCESS_KEY_ID": "airflow",
        "AWS_SECRET_ACCESS_KEY": "minioairflow",
        "ELYRA_ENABLE_PIPELINE_INFO": "True",
...
op_64cea8a9_2c46_43ff_9b26_57896583fd00.image_pull_policy = "Always"

op_64cea8a9_2c46_43ff_9b26_57896583fd00 << op_05b70e06_79ee_4046_8e38_d81304c8c267
